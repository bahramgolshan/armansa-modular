...
Route::get('/services/lithography/zinc.gto', "SomeController@index")->name('service.lithography'); // لیتوگرافی
Route::get('/services/lithography/zinc.gto', "SomeController@index")->name('service.lithography.zinc-gto'); // زینک gto
Route::get('/services/lithography/zinc.gto', "SomeController@index")->name('service.lithography.zinc-dureghi'); // زینک دورقی
Route::get('/services/lithography/zinc.gto', "SomeController@index")->name('service.lithography.zinc-speed-master'); // زینک اسپید مستر
