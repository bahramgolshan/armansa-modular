...
<section class="py-[2.5rem] lg:py-[4.5rem] custom-padding">
    <div class="navigation-container mx-auto text-[--primary-color]">
        <div class="">
            ...
            <h3 class="mx-auto text-center lg:text-[28px] xl:text-[32px] font-bold my-[1rem]">مجتمع چاپ آرمانسا</h3>
        </div>
        ...
        <div class="flex items-center my-[2rem]">
            ...
            <div class="mx-[1rem]">
                <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect y="4.24219" width="6" height="6" transform="rotate(-45 0 4.24219)" fill="#A3A3A3" />
                </svg>
            </div>
            <div class="w-[50%] h-[2px] bg-[#A3A3A3]"></div>
        </div>
