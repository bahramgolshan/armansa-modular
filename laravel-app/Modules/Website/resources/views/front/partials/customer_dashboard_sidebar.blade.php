          <div class="hidden lg:block lg:col-span-1 bg-transparent">
            ...
            >
              ...
              >
                <img
                  class="w-[24px] h-[24px]"
                  src="{{asset('images/front/dashboard/edit.png')}}"
                />
                <span
                  class="text-center xl:text-[1.25rem] lg:text-[0.79rem] px-1 dashboard-sidebar-link"
                  >ویرایش پروفایل</span
                >
              </div>
              <div
              ...
              >
                <img
                  class="w-[24px] h-[24px]"
                  src="{{asset('images/front/dashboard/cart.png')}}"
                />
                <span
                  class="text-center xl:text-[1.25rem] lg:text-[0.79rem] px-1 dashboard-sidebar-link"
                  >سبد خرید</span
              ...
              >
                <img
                  class="w-[24px] h-[24px]"
                  src="{{asset('images/front/dashboard/print.png')}}"
                />
                <span
                  class="text-center xl:text-[1.25rem] lg:text-[0.79rem] px-1 dashboard-sidebar-link"
                  >سفارش های من</span
              ...
              >
                <img
                  class="w-[24px] h-[24px]"
                  src="{{asset('images/front/dashboard/logout.png')}}"
                />
                <span
                  class="text-center xl:text-[1.25rem] lg:text-[0.79rem] px-1 dashboard-sidebar-link"
                  >خروج از حساب</span
