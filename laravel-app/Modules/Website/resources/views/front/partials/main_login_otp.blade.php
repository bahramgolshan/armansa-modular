...
<section class="flex bg-[#f5f5f5] justify-center items-center py-[2rem]">
      ...
      >
        ...
        <div class="p-4 md:p-5">
          <div>
            <form
              class="h-[100%] flex flex-col justify-around items-center"
              action="#"
            >
              <div class="flex gap-[1rem] justify-center items-center my-5">
                ...
                <span
                  class="text-center text-[1.2rem] sm:text-[1.5rem] font-bold text-[#3C4999]"
                  >مجتمع چاپ آرمانسا</span
                >
              </div>
              <div class="grid grid-cols-1 my-5 w-[90%]">
                <span
                  class="text-center text-[1.4rem] mb-[1.5rem] text-[#3C4999]"
                  >رمز یک‌بار مصرف به شماره ۰۹۱۲۳۴۵۶۷۸۹ پیامک شده‌است.
                </span>
                <div
                  class="grid grid-cols-1 gap-y-[1rem] w-[80%] sm:w-[70%] md:w-[66%] mx-auto"
                >
                  <div class="sm:col-span-1 mt-[0.5rem]">
                    <label
                      for=""
                      class="text-right block text-md font-medium text-[#3C4999] leading-6"
                    >
              ...
              <button
                class="w-[200px] h-[50px] bg-[--primary-color] text-[1.125rem] text-white text-center mx-auto rounded-lg py-[.5rem] mt-5"
              >
                ادامه
              </button>
            </form>
        ...
        <div class="h-[1px] bg-black my-9 w-[90%] mx-auto"></div>
        <div class="flex flex-col gap-[0.7rem] justify-center items-center">
          <span class="text-md font-medium text-[#3C4999]"
            >حساب کاربری دارید؟</span
          >
          <button
            class="w-[200px] h-[50px] bg-[#00B6DE] text-[1.125rem] text-white text-center rounded-lg py-[.5rem]"
          >
            ثبت نام
          </button>
        </div>
