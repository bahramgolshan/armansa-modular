        ...
        >
          ...
          >
            <div class="flex flex-col justify-around items-center gap-y-3 p-9">
              <div
                class="flex flex-col justify-center items-center w-[200px] h-[200px]"
              >
                <img src="{{asset('images/front/dashboard/empty.png')}}" />
              </div>
              <div>
                <p class="text-center text-[1rem] lg:text-[1.25rem]">
                  سبد خرید شما خالی است! جهت ثبت سفارش می‌توانید خدمات آرمانسا
                  را مشاهده کنید.
                </p>
              </div>
