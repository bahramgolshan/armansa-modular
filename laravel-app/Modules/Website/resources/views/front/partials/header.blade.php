...
<header class="z-[200] w-[100%] fixed top-0" id="sticky-header">
                ...
                <div class="flex justify-between items-center">
                    <div class="lg:hidden sidebar-toggle">
                        <button class="navbar-burger flex items-center text-blue-600">
                            <img src="{{ asset('images/front/icon/hamburger.png') }}" alt="">
                        </button>
                    </div>
    ...
    <section class="bg-[#3C4999] custom-padding">
        <ul
            ...
            <li class="w-[0.3rem] h-[0.3rem] bg-white rotate-45"></li>
            <li><a class="text-sm" href="#">لیتوگرافی</a></li>
            <li class="w-[0.3rem] h-[0.3rem] bg-white rotate-45"></li>
            <li><a class="text-sm" href="#">سر رسید</a></li>
            <li class="w-[0.3rem] h-[0.3rem] bg-white rotate-45"></li>
            <li><a class="text-sm" href="#">درباره‌ما</a></li>
            <li class="w-[0.3rem] h-[0.3rem] bg-white rotate-45"></li>
            <li><a class="text-sm" href="#">نمونه‌کار</a></li>
        </ul>
    </section>
</header>
...
<div
    ...
    <img src="{{ asset('images/front/icon/white-close.png') }}" class="absolute top-[2rem] right-[1rem] close-button" />
    ...
    <ul class="p-4 mt-[3rem]">
        <li class="mb-[1rem] group">
            <div href="#" class="flex items-center py-2 px-4 text-gray-300 sidebar-dropdown-toggle">
                ...
                <img src="{{ asset('images/front/icon/white-chevron-down.png') }}"
