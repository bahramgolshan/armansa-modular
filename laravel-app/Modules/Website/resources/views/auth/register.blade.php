            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <p class="mb-4">برای ثبت نام لطفا اطلاعات مورد نیاز را وارد کنید:</p>
                        ...
                        <div class="divider my-4">
                            <div class="divider-text">حساب کاربری دارید؟</div>
                        </div>

                        <div class="mb-3">
                            <a class="btn btn-outline-primary d-grid w-100" href="{{ route('login') }}">ورود</a>
                        </div>
