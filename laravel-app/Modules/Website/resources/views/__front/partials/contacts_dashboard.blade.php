          ...
          >
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-2 sm:col-start-1">
                <label
                  for="fullname"
                  class="block text-sm font-medium leading-6 text-[#3B4999] lg:text-[18px]"
              ...
              <div class="sm:col-span-2">
                <label
                  for="email"
                  class="block text-sm font-medium leading-6 text-[#3c4999] lg:text-[18px]"
                  >ادرس ایمیل:</label
                >
                <div class="mt-2">
                  <input
              ...
              <div class="col-span-full">
                ...
                <div
                  class="flex items-center gap-[1rem] justify-center sm:justify-end mt-5"
                >
                  <button
