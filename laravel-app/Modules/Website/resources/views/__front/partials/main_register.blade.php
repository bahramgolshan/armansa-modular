<!-- main -->
<section class="flex bg-[#f5f5f5] justify-center items-center py-[2rem]">
    <div
        class="w-[95%] md:w-[30rem] justify-around bg-white rounded-lg rounded-[15px] shadow-[-2px_2px_8px_3px_rgba(0.15,0.15,0.15,0.15)] relative sm:pb-[1rem]">
        <div class="flex justify-end absolute top-[1rem] left-[1rem]">
            <img class="" src="{{ asset('assets/modules/website/images/icon/close.png') }}" alt="" />
        </div>
        <div class="p-4 md:p-5">
            <div>
                <form class="h-[100%] flex flex-col justify-center items-center" action="#">
                    <div class="flex gap-[1rem] justify-center items-center my-5">
                        ...
                        <span class="text-center text-[1.2rem] sm:text-[1.5rem] font-bold text-[#3C4999]">مجتمع چاپ
                            آرمانسا</span>
                    </div>
                    <div class="grid grid-cols-1 my-5 w-[100%]">
                        <h3 class="text-center text-[1.4rem] font-bold mb-[1rem] text-[#3C4999]">
                            ثبت نام
                        </h3>
                        <div class="grid grid-cols-1 gap-y-[1rem] w-[80%] sm:w-[70%] md:w-[66%] mx-auto">
                            <div class="sm:col-span-1">
                                <label for="name"
                                    class="text-right block text-md font-medium text-[#3C4999] leading-6">نام و نام
                                    خانوادگی :</label>
                                <div class="mt-2">
                                    <input type="text" name="full-name" id="full-name" autocomplete="given-name"
                                        class="block w-[100%] border border-[--primary-color] text-[--primary-color] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" />
                                </div>
                            </div>

                            <div class="sm:col-span-1">
                                <label for="mobile"
                                    class="text-right block text-md font-medium text-[#3C4999] leading-6">تلفن همراه
                                    :</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-1">
                                <label for="email"
                                    class="text-right block text-md font-medium text-[#3C4999] leading-6">آدرس ایمیل
                                    :</label>
                                <div class="mt-2">
                        ...
                        <button
                            class="w-[200px] h-[50px] bg-[#00B6DE] text-[1.125rem] text-white text-center mx-auto rounded-lg py-[.5rem] mt-5">
                            ثبت نام
                        </button>
                    </div>
                </form>
            </div>
            <div class="h-[1px] bg-black my-6 w-[90%] mx-auto"></div>
            <div class="flex flex-col gap-[0.7rem] justify-center items-center">
                <span class="text-md font-medium text-[#3C4999]">حساب کاربری دارید؟</span>
                <a class="w-[200px] h-[50px] bg-[--primary-color] text-[1.125rem] text-white text-center rounded-lg py-[.5rem]"
                    href="{{ route('login') }}">
                    ورود
                </a>
            </div>
