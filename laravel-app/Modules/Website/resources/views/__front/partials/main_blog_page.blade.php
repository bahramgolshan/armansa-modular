    <section class="custom-padding bg-neutral-100">
        <div
            ...
            <div>
                <p class="w-[100%] text-right text-indigo-500 xl:text-[1.5rem] md:text-[1.2rem] text-[1rem]">
            ...
            <div>
                <p class="mt-[20px] w-[100%] text-right text-indigo-500 xl:text-[1.5rem] md:text-[1.2rem] text-[1rem]">
                    لوازم ایپسوم متن ساختگی با تولید سادگی نا مفهوم از صنعت چاپ ، و با
                    استفاده از طراحان گرافیک است. لوازم ایپسوم متن ساختگی با تولید سادگی
                    نا مفهوم از صنعت چاپ ، و با استفاده از طراحان گرافیک است. لوازم
                    ایپسوم متن ساختگی با تولید سادگی نا مفهوم از صنعت چاپ ، و با استفاده
            ...
            <div class="mt-[20px]">
                <img class="w-[100%] h-auto" src="{{ asset('assets/modules/website/images/blog/Frame 51.png') }}" />
            </div>
                ...
                <div class="swiper blog-swiper mx-auto h-full">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide bg-white flex items-center justify-center">
                            <img class="" src="{{ asset('assets/modules/website/images/home/slider/1.jpg') }}" />
                        </div>
                        <div class="swiper-slide bg-white flex items-center justify-center">
                            <img class="" src="{{ asset('assets/modules/website/images/home/slider/2.jpg') }}" />
                        </div>
                        <div class="swiper-slide bg-white flex items-center justify-center">
                            <img class="" src="{{ asset('assets/modules/website/images/home/slider/3.jpg') }}" />
                        </div>
                        <div class="swiper-slide bg-white flex items-center justify-center">
                            <img class="" src="{{ asset('assets/modules/website/images/home/slider/1.jpg') }}" />
                        </div>
                    ...
                    <div class="hidden sm:flex sm:bg-opacity-[70%] overflow-hidden rounded-[100%] swiper-button-prev">
                    </div>
                    <div class="hidden sm:flex sm:bg-opacity-[70%] overflow-hidden rounded-[100%] swiper-button-next">
                    </div>
