...
TemplateCustomizer.LANGUAGES = {
  ...
  fa: {
    panel_header: 'شخصی سازی قالب',
    panel_sub_header: 'سفارشی سازی و پیش نمایش در زمان واقعی',
    theming_header: 'موضوع بندی',
    theme_header: 'موضوع',
    theme_label: 'موضوعات',
    ...
    layout_fixed: 'ثابت', //
    layout_fixed_offcanvas: 'ثابت خارج از بوم',
    layout_flipped_label: 'منوی معکوس',
    layout_dd_open_label: 'باز شدن کشویی هنگام حرکت',
    layout_navbar_label: 'نوار ناوبری ثابت',
    layout_footer_label: 'پایین صفحه ثابت',
    misc_header: 'متفرقه',
    rtl_label: 'جهت راست به چپ'
  },
  fr: {
