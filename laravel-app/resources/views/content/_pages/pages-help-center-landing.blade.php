                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="row">
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/rocket.svg') }}" height="60"
                            ...
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/gift.svg') }}" height="60"
                                            alt="Help center landing">
                                        <h5>First Steps</h5>
                            ...
                            <div class="col-md-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/keyboard.svg') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Account</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Authentication</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Billing</a></li>
                                        </ul>
                                        <p class="mb-0">
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Processing orders</a>
                                            </li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Payments</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Returns, Refunds and
                                                    Replacements</a></li>
                                        </ul>
                                        <p class="mb-0">
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Security and hacked
                                                    accounts</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Privacy</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Spam and fake
                                                    accounts</a></li>
                                        </ul>
                                        <p class="mb-0">
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">General</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Intellectual
                                                    property</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Guidelines for law
                                                    enforcement</a></li>
                                        </ul>
                                        <p class="mb-0">
                                            <a href="javascript:void(0);" class="text-body">14 articles</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Account</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Authentication</a>
                                            </li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Billing</a></li>
                                        </ul>
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li class="text-primary py-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Conversations</a>
                                            </li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">Jobs</a></li>
                                            <li class="text-primary pb-1"><a
                                                    href="{{ url('pages/help-center-categories') }}">People</a></li>
                                        </ul>
                                        <p class="mb-0">
                                            <a href="javascript:void(0);" class="text-body">14 articles</a>
                                        </p>
                    ...
                    <div class="col-lg-10 mx-auto">
                        <div class="row">
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/laptop.svg') }}"
                                            height="60" alt="Help center landing">
                                        <h5>Blogging</h5>
                            ...
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/lightbulb.svg') }}"
                                            height="60" alt="Help center landing">
                            ...
                            <div class="col-md-4 mb-md-0 mb-4">
                                <div class="card border shadow-none">
                                    <div class="card-body text-center">
                                        <img class="mb-3" src="{{ asset('assets/svg/icons/discord.svg') }}"
                                            height="60" alt="Help center landing">
                                        <h5>Community</h5>
            ...
            <div class="container-xl">
                <div class="row justify-content-center py-5 my-4">
                    <div class="col-md-8 col-lg-6 text-center">
                        ...
                        <p class="mb-4"> Our specialists are always happy to help. Contact us during standard business
                            hours or email us 24/7 and we'll get back to you. </p>
