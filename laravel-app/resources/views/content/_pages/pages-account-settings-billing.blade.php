                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
                                <h6 class="alert-heading mb-1 d-flex align-items-end"><i
                                        class="mdi mdi-alert-outline mdi-20px me-2"></i>
                                ...
                                <div class="cardMaster bg-lighter p-3 rounded mb-3">
                                    <div class="d-flex justify-content-between flex-sm-row flex-column">
                                        ...
                                        <div class="d-flex flex-column text-start text-lg-end">
                                            ...
                                            <small class="mt-sm-auto mt-2 order-sm-1 order-0 text-muted">Card expires at
                                                12/26</small>
                                        </div>
                                    </div>
                                </div>
