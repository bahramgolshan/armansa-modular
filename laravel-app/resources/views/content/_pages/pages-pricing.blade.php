    ...
    <div class="card">
        ...
        <div class="pb-sm-5 pb-2 rounded-top">
            <div class="container py-5">
                ...
                <p class="text-center text-muted">All plans include 40+ advanced tools and features to boost your product.
                            ...
                            <div class="card-body position-relative">
                                ...
                                <div class="text-center">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <h1
                                            class="price-toggle price-monthly fw-semibold display-3 text-primary mb-0 d-none">
                                            9</h1>
                        ...
                        <div class="card border rounded shadow-none">
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <sup class="h6 pricing-currency mt-3 mb-0 me-1 text-body fw-normal">$</sup>
                                        <h1 class="price-toggle price-yearly fw-semibold display-3 text-primary mb-0">16
                                        </h1>
                                        <h1
                                            class="price-toggle price-monthly fw-semibold display-3 text-primary mb-0 d-none">
                                            19</h1>
                                ...
                                <a href="{{ url('auth/register-basic') }}"
                                    class="btn btn-outline-primary d-grid w-100">Upgrade</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="pricing-free-trial">
            <div class="container">
                <div class="position-relative">
                    <div
                        class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center py-4 my-2 px-5">
                        <div class="text-center text-lg-start mt-3 ms-3">
                            ...
                            <a href="{{ url('auth/register-basic') }}" class="btn btn-primary mt-4 mb-3">Start 14-day FREE
                                trial</a>
                        </div>
                        <!-- image -->
                        <div class="text-center">
                            <img src="{{ asset('assets/img/illustrations/pricing-illustration.png') }}"
                                class="img-fluid me-lg-5 pe-lg-1 mb-3 mb-lg-0" alt="Api Key Image" width="210">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-striped text-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <span
                                                    class="badge badge-pro rounded-pill bg-primary w-px-20 h-px-20 d-flex align-items-center justify-content-center"><i
                                                        class="mdi mdi-star mdi-14px"></i></span>
                                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge rounded-pill bg-primary h-px-18 w-px-18 d-flex align-items-center justify-content-center mx-auto"><i
                                                    class="mdi mdi-check mdi-14px"></i></span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge rounded-pill bg-primary h-px-18 w-px-18 d-flex align-items-center justify-content-center mx-auto"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge rounded-pill bg-light w-px-18 h-px-18 d-flex align-items-center justify-content-center mx-auto"><i
                                                    class="mdi mdi-close mdi-14px"></i></span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge rounded-pill bg-light w-px-18 h-px-18 d-flex align-items-center justify-content-center mx-auto"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-label-primary badge-sm rounded-pill text-uppercase">Add-on
                                                Available</span>
                                        </td>
                                        <td>
                                            <span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('auth/register-basic') }}"
                                                class="btn text-nowrap btn-outline-primary">Choose Plan</a>
                                        </td>
                                        <td>
                                            <a href="{{ url('auth/register-basic') }}"
