        ...
        function deleteItem(id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    let route = "{!! route('app-blog-delete', ['id' => '-1']) !!}";
...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">بلاگ /</span> لیست پست ها
    </h4>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('app-blog-preview', ['id' => $post->id]) }}"><i
                                                class="mdi mdi-eye-outline me-1"></i>مشاهده</a>
                                        <a class="dropdown-item"
                                            href="{{ route('app-blog-edit', ['id' => $post->id]) }}"><i
                                                class="mdi mdi-pencil-outline me-1"></i> ویرایش</a>
                                        <button class="dropdown-item text-danger"
                                            onclick="deleteItem({{ $post->id }})"><i
