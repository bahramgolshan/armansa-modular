...
@section('content')
    <form class="row" action="{{ route('app-faq-store') }}" method="POST">
        @csrf
        <!-- faqs Add-->
        <div class="col-lg-9 col-12 mb-lg-0 mb-4">
            <div class="">
                ...
                <div class="card mb-4">
                    <h5 class="card-header mb-2">فرم ثبت سوالات متداول</h5>
                    <div class="card-body">
                        <div class="row pt-3">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="basic-default-answer" class="form-control" placeholder="پاسخ" aria-label="پاسخ"
                                        aria-describedby="basic-icon-default-answer" name="answer"></textarea>
