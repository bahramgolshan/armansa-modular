...
@section('content')
    ...
    <div class="app-email card">
                        ...
                        <div class="card-body emails-list-header p-3 py-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center w-100">
                                    <i class="mdi mdi-menu mdi-24px cursor-pointer d-block d-lg-none me-3"
                                ...
                                <div class="d-flex align-items-center mb-0 mb-md-2">
                                    ...
                                    <div class="dropdown">
                                        <button
                                            ...
                                            data-bs-toggle="dropdown" aria-expanded="true" id="emailsActions"><i
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown mx-1">
                                        <button
                                            class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                            id="dropdownMenuFolderOne" data-bs-toggle="dropdown" aria-expanded="true"><i
                                                class="mdi mdi-folder-outline mdi-24px"></i></button>
                                    ...
                                    <div class="dropdown mx-1">
                                        <button
                                            class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                            data-bs-toggle="dropdown" aria-expanded="true" id="dropdownLabelOne"><i
                                                class="mdi mdi-label-outline mdi-24px"></i></button>
                                ...
                                <div
                                    ...
                                    <span class="btn btn-icon btn-text-secondary rounded-pill btn-sm">
                                        <i
                                            class="email-prev mdi mdi-chevron-left cursor-pointer text-muted scaleX-n1-rtl"></i>
                                    </span>
                                    <span class="btn btn-icon btn-text-secondary rounded-pill btn-sm">
                            ...
                            <ul class="list-unstyled m-0">
                                <li class="email-list-item email-marked-read" data-starred="true"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <i
                                            class="email-list-item-bookmark mdi mdi-star-outline mdi-24px d-sm-inline-block d-none cursor-pointer ms-1 me-3"></i>
                                        <img src="{{ asset('assets/img/avatars/1.png') }}" alt="user-avatar"
                                            class="d-block flex-shrink-0 rounded-circle me-sm-3 me-0" height="32"
                                            width="32" />
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            <span class="email-list-item-username me-2 h6">Chandler Bing</span>
                                            <span class="email-list-item-subject d-xl-inline-block d-block"> Focused
                                                impactful open issues from the project of GitHub</span>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            ...
                                            <ul class="list-inline email-list-item-actions">
                                                <li class="list-inline-item email-unread"> <i
                                                        class='mdi mdi-email-outline mdi-24px'></i> </li>
                                                <li class="list-inline-item email-delete"> <i
                                                        class='mdi mdi-delete-outline mdi-24px'></i></li>
                                                <li class="list-inline-item"> <i
                                                        class="mdi mdi-alert-circle-outline mdi-24px"></i> </li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            ...
                                            <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy,
                                                Dessert soufflé tootsie roll soufflé carrot cake halvah jelly.</span>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                ...
                                <li class="email-list-item email-marked-read" data-draft="true" data-bs-toggle="sidebar"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            ...
                                            <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy,
                                                Soufflé apple pie caramels soufflé tiramisu bear claw.</span>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-attachment mdi mdi-attachment mdi-20px cursor-pointer me-2 float-end float-sm-none"></span>
                                            <span
                                                class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                                        ...
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            ...
                                            <ul class="list-inline email-list-item-actions">
                                                <li class="list-inline-item email-read"> <i
                                                        class='mdi mdi-email-open-outline mdi-24px'></i> </li>
                                                <li class="list-inline-item email-delete"> <i
                                                        class='mdi mdi-delete-outline mdi-24px'></i></li>
                                                <li class="list-inline-item"> <i
                                                        class="mdi mdi-alert-circle-outline mdi-24px"></i> </li>
                                ...
                                <li class="email-list-item" data-trash="true" data-bs-toggle="sidebar"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            ...
                                            <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy, I
                                                love danish. Cupcake I love carrot cake sugar plum I love.</span>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-label badge badge-dot bg-primary d-none d-md-inline-block me-2"
                                ...
                                <li class="email-list-item" data-starred="true" data-bs-toggle="sidebar"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                            ...
                                            <span class="email-list-item-subject d-xl-inline-block d-block"> Hey Katy,
                                                Icing gummi bears ice cream croissant dessert wafer.</span>
                                        </div>
                                        <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                            <span
                                                class="email-list-item-attachment mdi mdi-attachment mdi-20px cursor-pointer me-2 float-end float-sm-none"></span>
                                ...
                                <li class="email-list-item" data-spam="true" data-bs-toggle="sidebar"
                                    data-target="#app-email-view">
                                    <div class="d-flex align-items-center">
                                        <div class="form-check mb-0">
                                            <input class="email-list-item-input form-check-input" type="checkbox"
                    ...
                    <div class="card-body app-email-view-header p-3 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center py-2">
                            <div class="d-flex align-items-center overflow-hidden">
                                <i class="mdi mdi-chevron-left mdi-20px cursor-pointer me-2" data-bs-toggle="sidebar"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown ms-3">
                                    <button class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                        data-bs-toggle="dropdown" aria-expanded="true" id="dropdownMoreOptions"><i
                                            class="mdi mdi-dots-vertical mdi-20px"></i></button>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="btn btn-text-secondary btn-icon rounded-pill">
                                    <i class='mdi mdi-email-outline mdi-24px cursor-pointer' data-bs-toggle="sidebar"
                                        data-target="#app-email-view"></i>
                                </div>
                                <div class="dropdown mx-1">
                                    <button class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                        data-bs-toggle="dropdown" aria-expanded="true" id="dropdownMenuFolderTwo"><i
                                            class="mdi mdi-folder-outline mdi-24px"></i></button>
                                ...
                                <div class="dropdown mx-1">
                                    <button class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                        data-bs-toggle="dropdown" aria-expanded="true" id="dropdownLabelTwo"><i
                                            class="mdi mdi-label-outline mdi-24px"></i></button>
                        ...
                        <div class="card email-card-prev mx-sm-4 mx-3 border">
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <i
                                        class="email-list-item-bookmark mdi mdi-star-outline mdi-20px cursor-pointer me-3"></i>
                                    <div class="dropdown me-3">
                                        <button
                                            class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                            data-bs-toggle="dropdown" aria-expanded="true" id="dropdownEmailTwo"><i
                                                class="mdi mdi-dots-vertical mdi-20px"></i></button>
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown me-3">
                                        <button
                                            class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                            data-bs-toggle="dropdown" aria-expanded="true" id="dropdownEmailOne"><i
                                                class="mdi mdi-dots-vertical mdi-20px"></i></button>
        ...
        <div class="app-email-compose modal" id="emailComposeSidebar" tabindex="-1"
            aria-labelledby="emailComposeSidebar" aria-hidden="true">
                            ...
                            <div class="email-compose-actions d-flex justify-content-between align-items-center mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <label for="attach-file"><i
                                            class="mdi mdi-attachment mdi-20px cursor-pointer ms-2"></i></label>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow"
                                            data-bs-toggle="dropdown" aria-expanded="true" id="dropdownMoreActions"><i
                                                class="mdi mdi-dots-vertical mdi-20px"></i></button>
                                    ...
                                    <button type="reset" class="btn btn-icon btn-text-secondary rounded-pill"
                                        data-bs-dismiss="modal" aria-label="Close"><i
                                            class="mdi mdi-delete-outline mdi-20px"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
