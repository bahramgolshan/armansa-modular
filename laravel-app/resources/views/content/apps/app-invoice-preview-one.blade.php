                ...
                <div class="card-body">
                    <div class="px-4 d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                        <div class="mb-xl-0 pb-3">
                            ...
                            <p class="mb-1">نام مشتری: <span>{{ $invoice->user->full_name ?? '--' }}</span></p>
                            <p class="mb-1">تاریخ: <span>{{ verta($invoice->created_at)->format('Y-m-d') ?? '--' }}</p>
                            <p class="mb-1">شماره تلفن:<span>{{ $invoice->user->mobile ?? '--' }}</span></p>
                            <p class="mb-1">آدرس:<span>{{ $invoice->user->adderss ?? '--' }}</span></p>
