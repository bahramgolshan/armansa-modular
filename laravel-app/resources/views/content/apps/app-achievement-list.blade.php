        ...
        function deleteItem(id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    let route = "{!! route('app-achievement-delete', ['id' => '-1']) !!}";
...
@section('content')
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">آمار سایت /</span> لیست آمارهای سایت
    </h4>

    {{-- add button --}}
    <a href="/app/achievement/add" class="btn btn-primary mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('app-achievement-preview', ['id' => $achievement->id]) }}"><i
                                                class="mdi mdi-eye-outline me-1"></i>مشاهده</a>
                                        <a class="dropdown-item"
                                            href="{{ route('app-achievement-edit', ['id' => $achievement->id]) }}"><i
                                                class="mdi mdi-pencil-outline me-1"></i> ویرایش</a>
                                        <button class="dropdown-item text-danger"
                                            onclick="deleteItem({{ $achievement->id }})"><i
