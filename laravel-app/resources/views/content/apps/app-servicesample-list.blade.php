...
@section('title', 'servicesample List - Pages')
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="/app/servicesample/preview"><i class="mdi mdi-eye-outline me-1"></i>مشاهده</a>
                <a class="dropdown-item" href="/app/servicesample/edit"><i class="mdi mdi-pencil-outline me-1"></i> ویرایش</a>
