        ...
        function deleteItem(id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    let route = "{!! route('app-blog-category-delete', ['id' => '-1']) !!}";
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('app-blog-category-preview', ['id' => $blogCategory->id]) }}"><i
                                                class="mdi mdi-eye-outline me-1"></i>مشاهده</a>
                                        <a class="dropdown-item"
                                            href="{{ route('app-blog-category-edit', ['id' => $blogCategory->id]) }}"><i
                                                class="mdi mdi-pencil-outline me-1"></i> ویرایش</a>
                                        <button class="dropdown-item text-danger"
                                            onclick="deleteItem({{ $blogCategory->id }})"><i
