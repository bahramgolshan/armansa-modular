...
@section('title', 'Preview - achievements')
...
@section('content')
    ...
    <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="prefix" class="form-control" id="basic-default-prefix"
                                        placeholder="پیشوند" value="{{ $achievement->prefix }}" disabled />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="number" class="form-control" id="basic-default-number"
                                        placeholder="عدد" value="{{ $achievement->number }}" disabled />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="suffix" class="form-control" id="basic-default-suffix"
                                        placeholder="پسوند" value="{{ $achievement->suffix }}" disabled />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="order" class="form-control" id="basic-default-order"
                                        placeholder="اولویت" value="{{ $achievement->order }}" disabled />
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="is_featured"
                                                {{ $achievement->is_featured ? 'checked' : '' }} disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-lg-3 col-12">
            <div class="card mb-4">
                <div class="card-body">
                    <a href="{{ route('app-achievement-list') }}" class="btn btn-outline-secondary d-grid w-100">بازگشت</a>
                </div>
            </div>
        </div>
        <!-- /achievements Actions -->
