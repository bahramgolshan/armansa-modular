                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="flex-grow-1 row">
                            ...
                            <div class="col-5 text-end">
                                <button class="btn btn-text-secondary btn-icon rounded-pill"><i
                                        class="mdi mdi-link-variant mdi-24px"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        ...
                        <div class="flex-grow-1 row">
                            ...
                            <div class="col-5 text-end">
                                <button class="btn btn-text-danger btn-icon rounded-pill"><i
