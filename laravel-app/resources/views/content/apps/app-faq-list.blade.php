        ...
        function deleteItem(id) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    let route = "{!! route('app-faq-delete', ['id' => '-1']) !!}";
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('app-faq-preview', ['id' => $faq->id]) }}"><i
                                                class="mdi mdi-eye-outline me-1"></i>مشاهده</a>
                                        <a class="dropdown-item" href="{{ route('app-faq-edit', ['id' => $faq->id]) }}"><i
                                                class="mdi mdi-pencil-outline me-1"></i> ویرایش</a>
                                        <button class="dropdown-item text-danger"
                                            onclick="deleteItem({{ $faq->id }})"><i
