...
@section('content')
    ...
    <form class="row" action="{{ route('app-product-update', ['id' => $serviceDetail->id]) }}" method="POST">
        @csrf
        <!-- product Add-->
        <div class="col-lg-9 col-12 mb-lg-0 mb-4">
            <div class="">
                ...
                <div class="card mb-4">
                    <h5 class="card-header mb-2">فرم ویرایش محصول جدید</h5>
                    <div class="card-body">
                        <h6>1. نام سرویس</h6>
                        <div class="row g-4">
                            <div class="col-md-6">
                                    ...
                                    <select type="text" id="service" name="service_id" class="form-control"
                                        ...
                                        @foreach ($services as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->service_id ? 'selected' : '' }}>
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="size" name="size_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['sizes'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->size_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="paper" name="paper_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['papers'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->paper_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="color" name="color_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['colors'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->color_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="cover" name="cover_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['covers'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->cover_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="binding" name="binding_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['bindings'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->binding_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="cellophane" name="cellophane_id" class="form-control"
                                        ...
                                        @foreach ($digitalPrintData['cellophanes'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->cellophane_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="binding_direction" name="binding_direction_id"
                                        ...
                                        @foreach ($digitalPrintData['bindingDirections'] as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $serviceDetail->binding_direction_id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="discount_type" name="discount_type"
                                        ...
                                        @foreach ($discountTypes as $item)
                                            <option value="{{ $item }}"
                                                {{ $item == $serviceDetail->discount_type ? 'selected' : '' }}>
                                                {{ __('app.discountType.' . $item) }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" min="0" step="any" id="price"
                                        name="price"value="{{ $serviceDetail->price }}"
                                        class="calc-final-price form-control"
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select type="text" id="status" name="status"
                                        ...
                                        @foreach ($status as $item)
                                            <option value="{{ $item }}"
                                                {{ $item == $serviceDetail->status ? 'selected' : '' }}>
