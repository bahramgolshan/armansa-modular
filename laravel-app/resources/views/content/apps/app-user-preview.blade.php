...
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
          <div class="mb-xl-0 pb-3">
            ...
            <h5>شانت عیسی قلیان</h5>
            </div>
            <p class="">تهران  خیابان ولیعصر ساختمان کیمیا پلاک 9 طبقه 4 شرکت نگین</p>
          </div>
          <div>
            ...
            <div>
              <span>ایمیل:</span>
              <span>ha.yarali2121@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table m-0">
          ...
          <tbody>
            <tr>
              <td class="text-nowrap">1234567</td>
              <td class="text-nowrap">1402/12/12</td>
              <td>$32</td>
              <td>1</td>
              <td>$32.00</td>
            </tr>
  ...
  <div class="col-xl-3 col-md-4 col-12 ">
    <div class="card">
      <div class="card-body">
        <button class="btn btn-primary d-grid w-100 mb-3" data-bs-toggle="offcanvas" data-bs-target="">
          <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="mdi mdi-send-outline scaleX-n1-rtl me-1"></i>بازگشت به لیست مشتریان</span>
        </button>
