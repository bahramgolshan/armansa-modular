                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class=" d-flex align-items-center flex-column">
                            <img class="img-fluid rounded mt-4 mb-3" src="{{ asset('assets/img/avatars/10.png') }}"
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled g-2 my-4">
                        <li class="mb-2 d-flex align-items-center"><i
                                class="mdi mdi-circle-medium text-lighter mdi-24px"></i><span>10 Users</span></li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="mdi mdi-circle-medium text-lighter mdi-24px"></i><span>Up to 10 GB storage</span>
                        </li>
                        <li class="mb-2 d-flex align-items-center"><i
                                class="mdi mdi-circle-medium text-lighter mdi-24px"></i><span>Basic Support</span></li>
                    </ul>
                    ...
                    <div class="progress mb-1 rounded" style="height: 6px;">
                        <div class="progress-bar rounded" role="progressbar" style="width: 80%;" aria-valuenow="80"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6 order-1 order-xl-0">
                            <div class="mb-4">
                                <p class="mb-1">Your Current Plan is <span class="fw-semibold text-heading">Basic</span>
                                </p>
                            ...
                            <div class="mb-4">
                                <h6 class="mb-1 fw-semibold"><span class="me-2">$199 Per Month</span> <span
                        ...
                        <div class="col-xl-6 order-0 order-xl-0">
                            ...
                            <div class="plan-statistics">
                                ...
                                <div class="progress mb-1 rounded" style="height: 10px;">
                                    <div class="progress-bar w-75 rounded " role="progressbar" aria-valuenow="75"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                ...
                <div class="card-header align-items-center">
                    ...
                    <div class="card-action-element">
                        <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal"
                            data-bs-target="#addNewCCModal"><i class="mdi mdi-plus me-1"></i>Add Card</button>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="cardMaster border p-3 rounded mb-3">
                            <div class="d-flex justify-content-between flex-sm-row flex-column">
                                ...
                                <div class="d-flex flex-column text-start text-lg-end">
                                    ...
                                    <small class="mt-sm-auto mt-2 order-sm-1 order-0 text-end">Card expires at
                                        12/26</small>
                                </div>
                            </div>
                        </div>
