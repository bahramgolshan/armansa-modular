                    ...
                    <div class="d-flex justify-content-between border-bottom mb-4">
                        ...
                        <div class="action-icons">
                            <a href="javascript:;" class="text-body me-1" data-bs-target="#enableOTP"
                                data-bs-toggle="modal"><i class="mdi mdi-pencil-outline"></i></a>
            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}"
                                        alt="Chrome" class="me-3" width="22" height="22"><span
                            ...
                            <tr>
                                <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}"
                                        alt="Chrome" class="me-3" width="22" height="22"><span
                                        class="text-heading">Chrome on Android</span></td>
                            ...
                            <tr>
                                <td class="text-truncate border-bottom-0"><img
                                        src="{{ asset('assets/img/icons/brands/chrome.png') }}" alt="Chrome"
                                        class="me-3" width="22" height="22"><span class="text-heading">Chrome
                                        on Android</span></td>
