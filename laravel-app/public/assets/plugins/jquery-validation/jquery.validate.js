    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            maxlength: $.validator.format(
                "لطفا بیش از {0} کاراکتر وارد نکنید."
            ),
            minlength: $.validator.format("لطفاً حداقل {0} کاراکتر وارد کنید."),
            rangelength: $.validator.format(
                "لطفاً مقداری بین {0} تا {1} کاراکتر وارد کنید."
            ),
            range: $.validator.format("لطفاً مقداری بین {0} و {1} وارد کنید."),
            max: $.validator.format(
                "لطفاً مقداری کمتر یا مساوی با {0} وارد کنید."
            ),
            min: $.validator.format(
                "لطفاً مقداری بزرگتر یا مساوی با {0} وارد کنید."
            ),
